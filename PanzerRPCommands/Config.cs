...
namespace PanzerRPCommands
{
    public class Config : IConfig
    {
        ...
        public CommandSettings Me { get; set; } = new(15f, 5f, "<size=25><align=left><color=Red>「Me」</color><color=#FFFF00>{0}</color> : {1}</align></size>");
        public CommandSettings Do { get; set; } = new(15f, 5f, "<size=25><align=left><color=green>「Do」</color><color=#FFFF00>{0}</color> : {1}</align></size>");
        public CommandSettings Look { get; set; } = new(15f, 5f, "<size=25><align=left><color=#00FFFF>「Look」</color><color=#FFFF00>{0}</color> : {1}</align></size>");
        public CommandSettings Ooc { get; set; } = new(15f, 5f, "<size=25><align=left><color=yellow>「Ooc」</color><color=#FFFF00>{0}</color> : {1}</align></size>");
        public CommandSettings Try { get; set; } = new(15f, 5f, "<size=25><align=left><color=yellow>「Try」</color><color=#FFFF00>{0}</color> : {1} | {2} </align></size>");
        public CommandSettings Desc { get; set; } = new(15f, 5f, "<size=25><align=left><color=blue>「Desc」</color><color=#FFFF00>{0}</color> : {1}</align></size>");
        public CommandSettings Assist { get; set; } = new(0f, 0f, "<color=red>[pomoc]</color> <color=#ffcc00>{0}</color>: {1}");
